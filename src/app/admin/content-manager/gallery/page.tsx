...
export default function GalleryPage() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const batchSnap = await getDocs(collection(db, "galleryBatches"));
        setBatches(
    ...
    return (
      <div className="border border-red-200 bg-red-50 p-4">
        ...
        <p className="mt-1 text-xs text-red-600">
          ...
          <code className="font-mono">galleryBatches</code> collection in Firestore rules, then refresh.
        </p>
      </div>
    );
  }
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 max-w-lg text-sm text-gray-500">
            Donation batches are groups of photos with a title (e.g.
            &quot;Donation to Korim — new home&quot;) tied to a program — these
            appear as cards on the public gallery and detail pages.
          </p>
        </div>
        <button
