...
description: Guides creation of distinctive, production-grade frontend interfaces that avoid generic "AI slop" aesthetics. Use when building UI components, pages, apps, or interfaces where visual quality and creative direction matter. Use when asked to implement frontend designs, create React/Vue/HTML components, or build visual interfaces.
---
